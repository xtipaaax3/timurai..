  ...
  return (
    <Tabs>
      ...
      <div className="my-2 text-[#444] dark:text-[#ddd]">
          UNESITE ISPOD SLJEDECE :<br></br>
          API HOST : https://api.aios.chat/v1/chat/completions <br></br>
          API KEY : ak-dTwfmszbhsoxsOv2ySuEReryYRPr0Ltwi09O02FCrcqrvhR3
        </div>
        <Form labelPosition="left" onValueChange={handleValuesChange}>
          ...
          <Form.Input field="apiHost" initValue={config.apiHost || API_HOST} />
